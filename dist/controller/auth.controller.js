...
exports.resetPasswordController = exports.forgotPasswordController = exports.loginController = exports.registerAdminController = exports.registerController = void 0;
...
const register_organizer_service_1 = require("../services/auth/register-organizer.service");
...
const registerAdminController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, register_organizer_service_1.registerOrganizerService)(req.body);
        res.status(200).send(result);
    }
    catch (error) {
        next(error);
